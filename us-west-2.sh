...
#import variable
region=us-west-2
amiubuntu=ami-09889d8d54f9e0a0e
...
#create
aws ec2 run-instances --region $region --image-id $amiubuntu --count 1 --instance-type $instancesType --key-name $keyname --security-group-ids $groupsecid --subnet-id $SubnetId --output text > us-west-2.txt
